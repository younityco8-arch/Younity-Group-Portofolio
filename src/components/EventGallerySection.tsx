...
export function EventGallerySection() {
  ...
  return (
    <section id="galeri" className="py-14 sm:py-20 lg:py-24 bg-white dark:bg-[#020617] relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-8 pb-8 border-b border-slate-200 dark:border-slate-800">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-600 dark:text-slate-400">
                <div className="flex items-center gap-2 bg-white dark:bg-[#020617] p-2.5 rounded-lg border border-slate-200 dark:border-slate-800">
            ...
            <div className="lg:col-span-5 bg-white dark:bg-[#020617] rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4 mb-5">
                <div className="bg-blue-50/70 dark:bg-blue-500/20 dark:bg-blue-50 dark:bg-blue-500/100/20 p-4 rounded-xl border border-blue-100 text-center">
                  ...
                  <div className="text-[10px] text-slate-500 dark:text-slate-400">100% Target Penjualan</div>
                </div>
                ...
                <div className="bg-amber-50/70 p-4 rounded-xl border border-amber-100 text-center">
                  ...
                  <div className="text-[10px] text-slate-500 dark:text-slate-400">Calon Buyer Terdata</div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {PORTFOLIO_EVENTS[0].photos.map((photo) => (
                <div
                  ...
                  className="group relative bg-white dark:bg-[#020617] rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 cursor-pointer hover:shadow-lg transition-all"
                >
                  <div className="aspect-4/3 overflow-hidden bg-slate-100 dark:bg-slate-800/50">
                    <img
                      src={photo.url}
                      alt={photo.title}
                  ...
                  <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
                    <div className="w-8 h-8 rounded-full bg-white dark:bg-[#020617]/90 text-slate-900 dark:text-white flex items-center justify-center shadow-md">
                      <Maximize2 className="w-4 h-4" />
                    </div>
                  </div>

                  {/* Caption Strip */}
                  <div className="p-3.5 bg-white dark:bg-[#020617] border-t border-slate-100 dark:border-slate-800/50">
                    <h5 className="text-xs font-bold text-slate-900 dark:text-white line-clamp-1 group-hover:text-blue-600 dark:text-blue-400 transition-colors">
                      {photo.title}
                    </h5>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2.5 sm:gap-4">
            {filteredPhotos.map((photo) => (
              <div
                key={photo.id}
                onClick={() => openPhoto(photo)}
                className="group relative bg-white dark:bg-[#020617] rounded-xl overflow-hidden border border-slate-200/80 cursor-pointer shadow-2xs hover:shadow-md hover:border-blue-400 transition-all"
              >
                <div className="aspect-square overflow-hidden bg-slate-100 dark:bg-slate-800/50">
                  <img
                    src={photo.url}
                    alt={photo.title}
                ...
                <div className="p-2.5 bg-white dark:bg-[#020617] block group-hover:hidden">
                  <div className="text-[11px] font-bold text-slate-800 dark:text-slate-200 line-clamp-1">{photo.title}</div>
                  <div className="text-[10px] text-slate-500 dark:text-slate-400">{photo.eventTitle}</div>
                </div>
              </div>
            ))}
          </div>
