      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            {/* Top Origin dan Credibility Pill */}
            ...
            <div className="relative bg-white dark:bg-[#020617] p-3 rounded-2xl border border-slate-100 dark:border-slate-800/50 shadow-xl shadow-slate-200/50">
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-2.5">
                ...
                <div className="relative group rounded-xl overflow-hidden aspect-4/3 bg-slate-100 dark:bg-slate-800/50">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent flex flex-col justify-end p-2.5 sm:p-3 text-white">
                    <span className="text-[9px] sm:text-[10px] uppercase font-bold text-blue-300">Exhibition dan Expo</span>
                ...
                <div className="relative group rounded-xl overflow-hidden aspect-4/3 bg-slate-100 dark:bg-slate-800/50">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent flex flex-col justify-end p-2.5 sm:p-3 text-white">
                    ...
                    <span className="text-[9px] sm:text-[10px] text-slate-200">Registrasi dan Operasional</span>
                  </div>
                </div>

                {/* Photo 4: Campus Creative dan Concert Stage */}
                <div className="relative group rounded-xl overflow-hidden aspect-4/3 bg-slate-100 dark:bg-slate-800/50">
                  <img
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent flex flex-col justify-end p-2.5 sm:p-3 text-white">
                    <span className="text-[9px] sm:text-[10px] uppercase font-bold text-purple-300">Stage dan Audio-Visual</span>
                    <h2 className="text-[11px] sm:text-xs font-bold leading-snug line-clamp-1">Full In-House Equipment</h2>
                    <span className="text-[9px] sm:text-[10px] text-slate-200">Lighting, LED dan Rigging</span>
                  </div>
                </div>
