...
export function Footer() {
  ...
  return (
    <footer id="kontak" className="bg-white border-t border-slate-200 pt-14 sm:pt-20 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-[#0066FF] to-blue-700 rounded-2xl sm:rounded-3xl p-5 sm:p-8 lg:p-12 text-white mb-14 sm:mb-20 shadow-xl relative overflow-hidden">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <a
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3.5 rounded-xl bg-white text-blue-700 hover:bg-blue-50 font-bold text-xs sm:text-sm shadow-md transition-all transform hover:-translate-y-0.5"
                >
            ...
            {/* Quick Contact Form */}
            <div className="lg:col-span-5 bg-white rounded-2xl p-5 sm:p-6 text-slate-800 shadow-2xl border border-white/20">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                <div>
                  <input
                    ...
                    className="w-full text-xs p-3 rounded-lg border border-slate-200 bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div>
                  <select
                    ...
                    className="w-full text-xs p-3 rounded-lg border border-slate-200 bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-slate-700"
                  >
                ...
                <div>
                  <textarea
                    ...
                    className="w-full text-xs p-3 rounded-lg border border-slate-200 bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                  />
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 pb-10 sm:pb-12 border-b border-slate-100 text-xs text-slate-600">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><a href="#tentang" className="hover:text-blue-600 transition-colors">Tentang Kami</a></li>
              <li><a href="#layanan" className="hover:text-blue-600 transition-colors">Layanan & Jasa</a></li>
              <li><a href="#galeri" className="hover:text-blue-600 transition-colors">Galeri Dokumentasi</a></li>
              <li><a href="#peralatan" className="hover:text-blue-600 transition-colors">Sewa Peralatan</a></li>
              <li><a href="#legalitas" className="hover:text-blue-600 transition-colors">Legalitas NIB OSS</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="text-slate-500 block text-[10px]">WhatsApp / Telepon</span>
                  <a href={COMPANY_INFO.whatsappUrl} className="font-bold text-slate-800 hover:text-blue-600 font-mono">
                    {COMPANY_INFO.phone}
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="text-slate-500 block text-[10px]">Email Bisnis</span>
                  <a href={`mailto:${COMPANY_INFO.email}`} className="font-semibold text-slate-800 hover:text-blue-600">
                    {COMPANY_INFO.email}
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="text-slate-500 block text-[10px]">Instagram</span>
                  <a href={COMPANY_INFO.instagramUrl} target="_blank" rel="noopener noreferrer" className="font-semibold text-slate-800 hover:text-blue-600">
              ...
              <li className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="text-slate-500 block text-[10px]">Domisili</span>
                  <span className="font-medium text-slate-800">{COMPANY_INFO.location}</span>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              type="button"
              onClick={scrollToTop}
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-700 hover:text-blue-600 bg-slate-50 hover:bg-slate-100 px-3 py-1.5 rounded-lg border border-slate-200 transition-colors"
            >
              <span>Ke Atas</span>
