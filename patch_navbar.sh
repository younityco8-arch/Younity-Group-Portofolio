sed -i '/{/* Mobile dan Tablet Hamburger Toggle */}/,/<\/header>/c\          {/* Mobile dan Tablet Hamburger Toggle */}\
...
\
            ...
            <a\
              ...
              className="inline-flex items-center gap-1 p-1.5 sm:px-2.5 sm:py-1.5 rounded-lg bg-green-500 hover:bg-green-600 text-white flex-shrink-0"\
            >\
